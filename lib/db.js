...
async function createTables() {
  ...
  `);
  await ensureColumn(monsterDb, 'monster_state', 'monsterId', 'TEXT');
  await ensureColumn(monsterDb, 'monster_state', 'title', 'TEXT');
  await ensureColumn(monsterDb, 'monster_state', 'hp', 'INTEGER');
  await ensureColumn(monsterDb, 'monster_state', 'maxHp', 'INTEGER');
  await ensureColumn(monsterDb, 'monster_state', 'spawnedAt', 'INTEGER');
